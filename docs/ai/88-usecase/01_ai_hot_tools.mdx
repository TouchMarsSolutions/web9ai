...
|------------|--------------|--------|------|------|----------|---------|
| 文生图之王 | 模型无数 一键生图 | 视频优质 | 文生视频 快手亲生 | 剪映旗下 字节亲生 | 3D 视频高清 | AI修图Pro | 
...
| 豆包 | 剪映 CapCut |
|------|------|
| [<Image img={DoubaoPng} style={{width: '80px', height: '80px'}} />](https://www.doubao.ai/) | [<CapcutSvg width={100} height={100} />](https://www.capcut.com/) |

## Summary

<details>
<summary>AI工具串烧</summary>
...
> _"Stay hungry, stay foolish."_ `<==>` _"若非生活所迫, 谁愿满身才华?"_ 
:::
