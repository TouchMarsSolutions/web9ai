...
import CozeSpace from '/img/coze/coze_space.png';
import Zapier from '/img/zapier/zapier_apps.png';
import Make from '/img/make/make_store.png';
...
import FullscreenWrapper from '@site/src/components/util/FullscreenWrapper';
...
<details>
  <summary>Category of AI Agent 智能代理的分类</summary>
...
### 流程管理 {#workflow-agent-mgmt}

| [Coze](https://www.coze.com/)                      | [**Zapier**](https://zapier.com/)             | [**Make**](https://www.make.com/) |
| -------------------------------------------------- | --------------------------------------------- | --------------------------------- |
| [<Image img={CozeStore} />](https://www.coze.com/) | [<Image img={Zapier} />](https://zapier.com/) | [<Image img={Make} />](https://www.make.com/) |
...
<details>
  <summary>Coze Space</summary>
  <div>
    [<Image img={CozeSpace} />](https://space.coze.cn/)
  </div>
</details>
...
<FullscreenWrapper>
  <Tabs
    defaultValue="llm"
    values={[
      {label: '概念强化', value: 'rpa'},
      {label: '幻相', value: 'hallucination'},
      {label: '大模型', value: 'llm'},
      {label: 'LLM使用L心法', value: 'use-llm'},
    ]}>
    <TabItem value="rpa">
:::danger
* `GenAI` = Generative AI 生成式AI
* 自动化 (RPA) vs AI
* AI vs ML
...
:::
    ...
    <TabItem value="llm">
      ```mermaid
      graph TD
        root["AI Models"] --> LLM["LLM (Text) 字"]
        root --> IMG["Image Generation 图像"]
        root --> AUD["Voice and Music 音频"]
        root --> VID["Video Generation 视频"]

        %% LLM derivatives
        LLM --> CODE["Code 编程代码"]
        LLM --> STORY["Story & Article <br/>小说/文案/故事"]
        LLM --> REASON["Prompt 提示词"]

        %% Style nodes
        classDef root fill:#ff9900,stroke:#fff,stroke-width:2px,color:#fff
        classDef primary fill:#00b4d8,stroke:#fff,stroke-width:2px,color:#fff
        classDef secondary fill:#0077b6,stroke:#fff,stroke-width:2px,color:#fff
        classDef desc fill:none,stroke:none

        class root root
        class LLM,IMG,AUD,VID primary
        class CODE,STORY,REASON secondary
        class CODE_DESC,STORY_DESC,REASON_DESC desc
      ```
    </TabItem>
    <TabItem value="hallucination">
...
| -------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------- |
| [<SunoSvg width={100} height={100} />](https://suno.com/invite/@jhcao) | [<UdioSvg width={100} height={100} />](https://www.udio.com/) | [<Image img={MurekaPng} width={100} height={100} />](https://mureka.ai/) | [<HaimianSvg width={150} height={100} />](https://www.haimian.com/) |
...
flowchart TB
    ...
    class Coze,Zapier,Manus,HeyGen,IMA,Get,Notion,ChatGPT,DeepSeek_LLM,Gemini,Grok3,Claude,Replicate,Huggingface,MidJourney,LibLib,Hailuo,Kling,Jimeng,PixVerse,Recraft,ElevenLabs,NotebookLM,Canva,Chuangkit,Napkin,Suno,Udio,Mureka,Haimian,Doubao,Capcut toolNode
```
