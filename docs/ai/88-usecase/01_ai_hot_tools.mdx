    ...
    subgraph Agents["智能体雏形<br/>AI Agents"]
        ...
        subgraph RAG["知识库Agent"]
            subgraph RAGTools["知识库工具"]
                direction LR
                IMA@{ img: '/img/rag/ima.png', label: "IMA知识库<br/>ima.qq.com", pos: "t", w: 80, h: 80}
                Get@{ img: '/img/rag/get.png', label: "Get笔记<br/>biji.com", pos: "t", w: 80, h: 80}
                Notion@{ img: '/img/rag/notion.svg', label: "Notion AI<br/>notion.so/product/ai", pos: "t", w: 80, h: 80}
            end
        end
    end
    ...
    subgraph Foundation["模型的直接应用层"]
        ...
        subgraph Drawing["神笔马良"]
            ...
            subgraph Video
                ...
                PixVerse@{img: '/img/txt2img/pixverse.svg', label: "PixVerse<br/>pixverse.ai", pos: "t", w: 160, h: 160}
            end
